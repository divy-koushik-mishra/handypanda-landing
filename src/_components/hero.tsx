...
const HeroWithContactForm: React.FC = () => {
  ...
  const handleWhatsAppContact = (e: React.FormEvent) => {
    ...
    const message = `Hi HandyPanda! My name is ${name} and my email is ${email}. I need help with: ${purpose}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-custom-white p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleWhatsAppContact} className="space-y-6">
              ...
              <div>
                <label htmlFor="email" className="block text-neutral-content font-medium mb-2">
                  Your Email
                </label>
                <input
                  type="email"
              ...
              <p className="text-center text-neutral-content/70 text-sm">
                Our team member will reach out to you regarding your query
              </p>
            </form>
          </div>
        </div>
